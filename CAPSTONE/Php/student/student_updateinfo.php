    ...
    <div class="container pt-5 pb-5">
        <div class="card shadow-sm">
            ...
            <div class="row px-4 gy-3 pb-4">
                    <div>
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <input name="yearlevel" type="text" class="form-control mt-2"  placeholder="3rd Year">
                        </div>

                        <div class="col-12 col-sm-3">
                            <label class="textcolorgreen">Program</label>
                            <input name="program" type="text" class="form-control mt-2"  placeholder="Computer Science">
                        </div>
            ...
            <div class="d-flex justify-content-between px-4 pt-2 pb-4">
                ...
                <a href="student_profile.php" class="text-decoration-none textcolorgreen btn BtN">
                    Update Information
                </a>
            </div>
        </div>
