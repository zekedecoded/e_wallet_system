                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="admin_view_student_info.php" class="btn btn-success btn-sm textcolorgreen">
                                                View
                                            </a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="admin_view_store_info.php" class="btn btn-success btn-sm textcolorgreen">
                                                View
                                            </a>
                                            <a href="#" class="btn btn-danger btn-sm textcolorred">
                                                Delete
